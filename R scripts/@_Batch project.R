...
"./R scripts/se2e_NE/strathE2E.06 EVENT TIMINGS JULIA.R",
"./R scripts/se2e_NE/strathE2E.07 REGION HARVEST JULIA.R",
...
# "./R scripts/se2e_NE/strathE2E.11 FIT ECO.R",
 # "./R scripts/se2e_NE/strathE2E.12 INITIAL CONDITIONS.R",
 # "./R scripts/se2e_NE/strathE2E.13 CLEAN FUTURES.R",                   
