...
unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Driving/chemistry_BRAZILIAN_SHELF_2010-2019.csv"))
#unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Param/physical_parameters_NORWEGIAN_BASIN.csv"))
unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Driving/physics_BRAZILIAN_SHELF_2010-2019.csv"))     # Delete old file
...
# 
 unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Target/annual_observed_SBS.csv"))
 unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Target/monthly_observed_SBS.csv"))
...
# 
 ...
 Setup_file[25,1] <- stringr::str_glue("regional_harvest_r_{toupper(implementation)}_2010-2019.csv")
