...
Physics_template <- read.csv(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Driving/physics_BRAZILIAN_SHELF_2010-2019.csv"))  # Read in example Physical drivers
